...
> Design and history live elsewhere: [`docs/archive/plans/racing-line-design.md`](../archive/plans/racing-line-design.md) is the
> original design (now carrying a long list of measured corrections), and ledger entries
> [**R23–R26**](../ledgers/improvements-ledger.md) record what each piece was actually worth.
