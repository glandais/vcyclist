...
[`PLAN-WASM-WASI.md`](PLAN-WASM-WASI.md).
...
[`elevation-integration.md`](elevation-integration.md). The host is what talks to that service, so
...
| What remains to be done on WASI | [`PLAN-WASM-WASI.md`](PLAN-WASM-WASI.md) |
