...
cœur (`:elevation`, `:gpx`, `:engine`, `:fit`) reste compilable sur toutes les cibles.
...
- ~~**g01 / packaging npm**~~ — **tranché** : `:gpx` n'est pas publié en npm, son code JS est
  ...
  [`docs/publishing.md`](../../guides/publishing.md#why-gpx-ships-to-maven-central-but-not-to-npm).
...
- ~~**g19 / licence du SDK Garmin**~~ — **tranché, non bloquant** : vcyclist ne redistribue aucun
  ...
  [`docs/publishing.md`](../../guides/publishing.md#fit-and-the-garmin-sdk-licence--the-decision).
