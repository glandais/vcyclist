...
- [x] Workflow se déclenche sur push develop (vérifié post-merge) — `.github/workflows/gh-pages.yml`
- [x] La page publiée sur `https://<user>.github.io/vcyclist/` charge correctement Stelvio + Enhance fonctionne

> **Clôture (2026-08-18, réorganisation `docs/`).** Les deux dernières cases étaient restées
> ouvertes faute d'avoir été recochées après le merge ; le workflow existe et publie. Cette fiche
> est close.
