 ...
 *
 * 1. `VirtualizeService.ts:67` seeds its simulation clock from `new Date().getTime()`, so
 *    its output is not reproducible and its time axis loses ~7 significant digits
 *    (float64 ULP is 2.44e-4 ms at 1.785e12, versus 1.16e-10 ms starting from 0).
